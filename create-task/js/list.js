const fishList = [
  ...
  },
  {
    ...
    imgAlt:
      "Black fish that fades to a lighter gray under side and two seperated dorsal fins.",
  ...
  },
  {
    ...
    imgAlt:
      "Orangeish-brown flatfish with both eyes on the right side of the body.",
  ...
  },
  {
    ...
    imgAlt: "Small fish with a blue-green back and light yelllow under side.",
  ...
  },
  {
    ...
    imgAlt: "Small reddish-pink crustean with a segmented body and 10 legs.",
  ...
  },
  {
    ...
    imgAlt:
      "Black backed fish with a light gray under side, a long bill, cresent-shaped tail, and stout body.",
  ...
  },
  {
    ...
    imgAlt:
      "Blu-green fish with a silvery white underbelly, 20 to 309 wavy black bars along the top half of their bofy, and a spindle shaped body.",
  ...
  },
  {
    ...
    imgAlt: "Torpedo shaped fish with a metallic dark blue back and upper sides, that change to yellow then white on the under side, their fins are bright yellow.",
    weight: "Up to 400 pounds",
  ...
  },
  {
    ...
    imgAlt: "Silvery fish with dark brown fins and bodies that are deeper then they are wide.",
    weight: "Up to 4 pounds",
    long: "Up to 20 inches",
    lifespan: "Up to 20 years",
    region: "Atlantic Ocean",
  },
  {
    ...
    imgAlt: "Light gray crustecean with a segmented body and 15 legs.",
  ...
  },
  {
    ...
    imgAlt: "Silvery fish with a brownish back, white under side, black speckles, and long pectoral fins.",
    weight: "Up to 5 pounds",
    long: "Up 28 inches",
    lifespan: "Up to 14 years",
    region: "Northwest Atlantic Ocean",
